...
RUN case "$(uname -m)" in \
    ...
    *) echo "unsupported architecture"; exit 1 ;; \
    ...
    && set -x \
    && curl -Lfs https://github.com/oznu/ffmpeg-for-homebridge/releases/download/v0.1.0/ffmpeg-alpine-${FFMPEG_ARCH}.tar.gz | tar xzf - -C / --no-same-owner
...
ENV CONFIG_UI_VERSION=4.45.0 HOMEBRIDGE_CONFIG_UI=1 HOMEBRIDGE_CONFIG_UI_PORT=8581
